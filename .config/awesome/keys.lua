...
keys.globalkeys = gears.table.join(
    ...
    awful.key( { superkey }, "XF86AudioMute",
        function()
    ...
    awful.key( { superkey }, "Print", function() apps.screenshot("clipboard") end,
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ superkey, ctrlkey}, "o",      function (c) c:move_to_screen()               end,
              {description = "move to screen", group = "client"}),
    awful.key({ superkey, }, "o", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "screen"}),
